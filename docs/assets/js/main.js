!(function () {
    ...
    (e.version = '2.3.7'),
        ...
        (e.Index.prototype.query = function (t) {
            for (
                var r = new e.Query(this.fields), i = Object.create(null), n = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), u = 0;
        ...
        (e.Builder.prototype.build = function () {
            return (
                ...
                this.createTokenSet(),
                new e.Index({ invertedIndex: this.invertedIndex, fieldVectors: this.fieldVectors, tokenSet: this.tokenSet, fields: Object.keys(this._fields), pipeline: this.searchPipeline })
            );
        }),
            ...
            return (
                ...
                (Viewport.prototype.hideShowToolbar = function () {
                    ...
                    (this.showToolbar = this.lastY >= this.scrollTop || 0 === this.scrollTop),
                        isShown !== this.showToolbar && (this.toolbar.classList.toggle('tsd-page-toolbar--hide'), this.secondaryNav.classList.toggle('tsd-navigation--toolbar-hide')),
        ...
        var MenuHighlight = (function (_super) {
            ...
            return (
                ...
                (MenuHighlight.prototype.onScroll = function (event) {
                    for (var scrollTop = event.detail.scrollTop + 5, anchors = this.anchors, count = anchors.length - 1, index = this.index; -1 < index && anchors[index].position > scrollTop; )
                        index -= 1;
                    for (; index < count && anchors[index + 1].position < scrollTop; ) index += 1;
                    this.index != index &&
                        (-1 < this.index && this.anchors[this.index].link.classList.remove('focus'), (this.index = index), -1 < this.index && this.anchors[this.index].link.classList.add('focus'));
                }),
                MenuHighlight
            );
        })(typedoc.Component);
            ...
            var Search = (function (_super) {
                ...
                return (
                    ...
                    (Search.prototype.setHasFocus = function (value) {
                        this.hasFocus != value &&
                            ((this.hasFocus = value), this.el.classList.toggle('has-focus'), value ? (this.setQuery(''), (this.field.value = '')) : (this.field.value = this.query));
                    }),
